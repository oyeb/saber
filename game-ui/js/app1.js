...
function start(){
    init_data.bot_data.forEach(function(bot) {
...
function updateEntities(dt) {
    ...
    // list of active connections in this turn {fdist, sink, length, src, arate, status}
    var active_conns = get_connections(turn);
    // list of {reserved, invested, owner}
    var server_status = get_servers_status(turn);
    ...
    gameState.bots_data[turn].forEach(function(bot) {
        bots[bot.id].reserved = bot.reserved;
