...
Can you upload a dummy template html page? Where can I see the available theme items online, myself?
I tried linking the `Contact Us` with `href="#contact-info"`. Didn't work. I don't know how its done anyways. Please tell.
```
rules
specs
calendar
